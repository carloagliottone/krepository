...
export class UserComponent implements OnInit {
  ...
  loadUserToEdit(userId: string) {  
    this.userService.getUserById(userId).subscribe(user=> {  
      ...
      this.userForm.controls['Formato'].setValue(user.Formato); 
      this.userForm.controls['Note'].setValue(user.Note); 
      this.userForm.controls['Ubicazione'].setValue(user.Note); 
      this.userForm.controls['Tipo'].setValue(user.Note); 
